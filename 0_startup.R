## Ù©(Â´á—œ`)?¿½? (Â´-`) .??¿½?¿½oO (Common function, 2020-09-15)
...
<<<<<<< HEAD
                    aT <- if (delta.(x, 'year') >= 3) format(x, '%Yå¹´') else if (delta.(x, 'month') >= 4) format(x, '%B') else format(x, '%H?¿½?')
=======
                    aT <- if (delta.(x, 'year') >= 3) format(x, '%Yå¹´') else if (delta.(x, 'month') >= 4) format(x, '%B') else format(x, '%H?¿½?')
>>>>>>> origin/master
                    return (aT)
...
<<<<<<< HEAD
    han <- c('??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½???¿½?','??¿½?¿½?¿½?','??¿½???¿½?','??¿½???¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?')
    zen <- c('ã‚¬','ã‚®','ã‚°','ã‚²','ã‚´','ã‚¶','ã‚¸','ã‚º','ã‚¼','ã‚¾','ãƒ€','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?')
=======
    han <- c('??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½?¿½??¿½?','??¿½???¿½?','??¿½?¿½?¿½?','??¿½???¿½?','??¿½???¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?','??¿½?¿½?¿½?')
    zen <- c('ã‚¬','ã‚®','ã‚°','ã‚²','ã‚´','ã‚¶','ã‚¸','ã‚º','ã‚¼','ã‚¾','ãƒ€','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?','?¿½?')
>>>>>>> origin/master
...
<<<<<<< HEAD
    out <- chartr('??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½???¿½?¿½?¿½???¿½???¿½???¿½???¿½???¿½?¿½?¾‰ï¾Šï¾‹ï¾Œï¾ï¾Žï¾ï¾ï¾‘ï¾’ï¾“ï¾”ï¾•ï¾–ï¾—ï¾˜ï¾™ï¾šï¾›ï¾œï½¦??¿½?¿½?½¡??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½',
                  'ã‚¢ã‚¤ã‚¦ã‚¨ã‚ªã‚«ã‚­ã‚¯ã‚±ã‚³ã‚µã‚·ã‚¹ã‚»ã‚½ã‚¿ãƒãƒ„?¿½?ãƒˆãƒŠãƒ‹ãƒŒãƒãƒŽãƒãƒ’ãƒ•ï¿½??¿½?¿½??¿½?¿½??¿½ãƒŸï¿½?ãƒ¡ãƒ¢ãƒ¤ãƒ¦ãƒ¨ãƒ©ãƒªãƒ«ãƒ¬ãƒ­ãƒ¯ãƒ²ãƒ³ã€‚ã€Œã€ã€??¿½??¿½ãƒ²ã‚¡ã‚£ã‚¥ã‚§ã‚©ãƒ£ãƒ¥ãƒ§?¿½?ãƒ¼', chr)
=======
    out <- chartr('??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½???¿½?¿½?¿½???¿½???¿½???¿½???¿½???¿½?¿½?¾‰ï¾Šï¾‹ï¾Œï¾ï¾Žï¾ï¾ï¾‘ï¾’ï¾“ï¾”ï¾•ï¾–ï¾—ï¾˜ï¾™ï¾šï¾›ï¾œï½¦??¿½?¿½?½¡??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½??¿½?¿½',
                  'ã‚¢ã‚¤ã‚¦ã‚¨ã‚ªã‚«ã‚­ã‚¯ã‚±ã‚³ã‚µã‚·ã‚¹ã‚»ã‚½ã‚¿ãƒãƒ„?¿½?ãƒˆãƒŠãƒ‹ãƒŒãƒãƒŽãƒãƒ’ãƒ•ï¿½??¿½?¿½??¿½?¿½??¿½ãƒŸï¿½?ãƒ¡ãƒ¢ãƒ¤ãƒ¦ãƒ¨ãƒ©ãƒªãƒ«ãƒ¬ãƒ­ãƒ¯ãƒ²ãƒ³ã€‚ã€Œã€ã€??¿½??¿½ãƒ²ã‚¡ã‚£ã‚¥ã‚§ã‚©ãƒ£ãƒ¥ãƒ§?¿½?ãƒ¼', chr)
>>>>>>> origin/master
