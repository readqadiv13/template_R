<<<<<<< HEAD
## Ù©(Â´á—œ`)Ùˆ (Â´-`) .ï½¡oO (Common function, 2020-09-15)
=======
## Ù©(Â´á—œ`)Ù? (Â´-`) .?½¡oO (Common function, 2020-09-15)
>>>>>>> origin/master
...
<<<<<<< HEAD
                    aT <- if (delta.(x, 'year') >= 3) format(x, '%Yå¹´') else if (delta.(x, 'month') >= 4) format(x, '%B') else format(x, '%Hæ™‚')
=======
                    aT <- if (delta.(x, 'year') >= 3) format(x, '%Yå¹´') else if (delta.(x, 'month') >= 4) format(x, '%B') else format(x, '%Hæ™?')
>>>>>>> origin/master
                    return (aT)
...
<<<<<<< HEAD
    han <- c('ï½¶ï¾ž','ï½·ï¾ž','ï½¸ï¾ž','ï½¹ï¾ž','ï½ºï¾ž','ï½»ï¾ž','ï½¼ï¾ž','ï½½ï¾ž','ï½¾ï¾ž','ï½¿ï¾ž','ï¾€ï¾ž','ï¾ï¾ž','ï¾‚ï¾ž','ï¾ƒï¾ž','ï¾„ï¾ž','ï¾Šï¾ž','ï¾‹ï¾ž','ï¾Œï¾ž','ï¾ï¾ž','ï¾Žï¾ž','ï¾Šï¾Ÿ','ï¾‹ï¾Ÿ','ï¾Œï¾Ÿ','ï¾ï¾Ÿ','ï¾Žï¾Ÿ')
    zen <- c('ã‚¬','ã‚®','ã‚°','ã‚²','ã‚´','ã‚¶','ã‚¸','ã‚º','ã‚¼','ã‚¾','ãƒ€','ãƒ‚','ãƒ…','ãƒ‡','ãƒ‰','ãƒ','ãƒ“','ãƒ–','ãƒ™','ãƒœ','ãƒ‘','ãƒ”','ãƒ—','ãƒš','ãƒ')
=======
    han <- c('?½¶?¾?','?½·?¾?','?½¸?¾?','?½¹?¾?','?½º?¾?','?½»?¾?','?½¼?¾?','?½½?¾?','?½¾?¾?','?½¿?¾?','?¾€?¾?','?¾??¾?','?¾‚ï¾?','?¾??¾?','?¾??¾?','?¾Šï¾?','?¾‹ï¾?','?¾Œï¾?','?¾ï¾?','?¾Žï¾?','?¾Šï¾?','?¾‹ï¾?','?¾Œï¾?','?¾ï¾?','?¾Žï¾?')
    zen <- c('ã‚¬','ã‚®','ã‚°','ã‚²','ã‚´','ã‚¶','ã‚¸','ã‚º','ã‚¼','ã‚¾','ãƒ€','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?','ãƒ?')
>>>>>>> origin/master
...
<<<<<<< HEAD
    out <- chartr('ï½±ï½²ï½³ï½´ï½µï½¶ï½·ï½¸ï½¹ï½ºï½»ï½¼ï½½ï½¾ï½¿ï¾€ï¾ï¾‚ï¾ƒï¾„ï¾…ï¾†ï¾‡ï¾ˆï¾‰ï¾Šï¾‹ï¾Œï¾ï¾Žï¾ï¾ï¾‘ï¾’ï¾“ï¾”ï¾•ï¾–ï¾—ï¾˜ï¾™ï¾šï¾›ï¾œï½¦ï¾ï½¡ï½¢ï½£ï½¤ï½¥ï½¦ï½§ï½¨ï½©ï½ªï½«ï½¬ï½­ï½®ï½¯ï½°',
                  'ã‚¢ã‚¤ã‚¦ã‚¨ã‚ªã‚«ã‚­ã‚¯ã‚±ã‚³ã‚µã‚·ã‚¹ã‚»ã‚½ã‚¿ãƒãƒ„ãƒ†ãƒˆãƒŠãƒ‹ãƒŒãƒãƒŽãƒãƒ’ãƒ•ãƒ˜ãƒ›ãƒžãƒŸãƒ ãƒ¡ãƒ¢ãƒ¤ãƒ¦ãƒ¨ãƒ©ãƒªãƒ«ãƒ¬ãƒ­ãƒ¯ãƒ²ãƒ³ã€‚ã€Œã€ã€ãƒ»ãƒ²ã‚¡ã‚£ã‚¥ã‚§ã‚©ãƒ£ãƒ¥ãƒ§ãƒƒãƒ¼', chr)
=======
    out <- chartr('?½±?½²?½³?½´?½µ?½¶?½·?½¸?½¹?½º?½»?½¼?½½?½¾?½¿?¾€?¾??¾‚ï¾??¾??¾??¾??¾??¾ˆï¾‰ï¾Šï¾‹ï¾Œï¾ï¾Žï¾ï¾ï¾‘ï¾’ï¾“ï¾”ï¾•ï¾–ï¾—ï¾˜ï¾™ï¾šï¾›ï¾œï½¦?¾ï½¡?½¢?½£?½¤?½¥?½¦?½§?½¨?½©?½ª?½«?½¬?½­?½®?½¯?½°',
                  'ã‚¢ã‚¤ã‚¦ã‚¨ã‚ªã‚«ã‚­ã‚¯ã‚±ã‚³ã‚µã‚·ã‚¹ã‚»ã‚½ã‚¿ãƒãƒ„ãƒ?ãƒˆãƒŠãƒ‹ãƒŒãƒãƒŽãƒãƒ’ãƒ•ã?˜ã?›ã?žãƒŸãƒ?ãƒ¡ãƒ¢ãƒ¤ãƒ¦ãƒ¨ãƒ©ãƒªãƒ«ãƒ¬ãƒ­ãƒ¯ãƒ²ãƒ³ã€‚ã€Œã€ã€ã?»ãƒ²ã‚¡ã‚£ã‚¥ã‚§ã‚©ãƒ£ãƒ¥ãƒ§ãƒ?ãƒ¼', chr)
>>>>>>> origin/master
    return (out)
}
...
=======
## Cumulative ratio plot == (2020-08-23) ================================================
crp. <- function(d, lty = NA, lwd = NA, xlab = '', ylab = '', col = NULL, Xlims = NA, Ylims = c(-0.01, 1.05), legePos = c(0.05, 0.98),
                 name = NULL, px = NULL, py = NULL, ...) {
    suppressMessages('devtools'::source_url('https://github.com/Nyu3/psd_R/blob/master/PSD_archive.R?raw=TRUE', keep.source = T, chdir = F))
>>>>>>> origin/master
...
=======
    for (i in seq_along(dL_res)) {cat('\n'); dL_res[[i]] %>% print(.); cat(str_c(str_dup('=', 48), '\n'))}
>>>>>>> origin/master
...
sp. <- function(d, col = NULL, xlab = '', ylab = '', cut = F, conv = T, ...) {  # (conv = T) means normalization of all data
    ...
    resultCol <- which(okngCol_TF) %>% names(.) %>% str_subset(., pattern = 'çµæžœ|Result|result') %>% .[1]  # If failed, return NA
...
=======
## My built-in data sets == (2020-09-04) ========================
>>>>>>> origin/master
psd <- 'tibble'::tibble (
